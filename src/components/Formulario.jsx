  ...
  return (
    <div className="md:w-1/2 lg:w-2/5">
      ...
      <form action="" className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
        ...
        <input type="submit" className="bg-indigo-600 w-full p-3 text-white font-bold uppercase hover:bg-indigo-700 cursor-pointer transition-colors" value="Agregar paciente"></input>
      </form>
    </div>
  );
};
